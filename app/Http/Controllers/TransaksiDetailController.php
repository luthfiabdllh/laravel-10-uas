...
class TransaksiDetailController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('transaksidetail.detail', $transaksidetail->id_transaksi)->with('pesan', 'Berhasil mengubah data');
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('transaksidetail.detail', $transaksidetail->id_transaksi)->with('pesan', 'Berhasil menghapus data');
        } catch (\Exception $e) {
            DB::rollback();
