                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4><span class="badge text-bg-primary">{{ number_format($transaksi_count, 0, '.', '.') }}</span></h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4><span class="badge text-bg-danger">{{ number_format($item_count, 0, '.', '.') }}</span></h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4><span class="badge text-bg-warning">Rp {{ number_format($omzet, 0, ',', '.') }}</span></h4>
                        </div>
                    </div>
                </div>
            </div>
